...
var CreateCategoryService = /** @class */ (function () {
    ...
    CreateCategoryService.prototype.execute = function (title) {
        return __awaiter(this, void 0, void 0, function () {
            var categoryRepository, category, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        err_1 = _a.sent();
                        throw new AppError_1.default('Error trying to create category');
