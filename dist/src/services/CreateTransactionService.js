...
var CreateTransactionService = /** @class */ (function () {
    ...
    CreateTransactionService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var transactionsRepository, newTransaction, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, transactionsRepository.create({
                                title: title,
                                value: value,
                                type: type,
                    ...
                    case 4:
                        err_1 = _b.sent();
                        throw new AppError_1.default('Error trying to create new transaction');
